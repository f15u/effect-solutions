...
import DOC__09 from "../../website/docs/09-project-structure.md" with {
  type: "text",
};
import DOC__10 from "../../website/docs/10-incremental-adoption.md" with {
  type: "text",
};
import DOC__11 from "../../website/docs/11-http-clients.md" with {
  type: "text",
};
